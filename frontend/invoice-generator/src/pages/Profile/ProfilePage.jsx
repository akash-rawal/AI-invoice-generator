...
import { Building, Building2, Loader2, Mail,MapPin,User } from "lucide-react";
    ...
    <div className="bg-white border border-slate-200 rounded-lg shadow-sm overflow-hidden max-w-4xl mx-auto">
      ...
      <form onSubmit={handleUpdateProfile}>
        <div className="p-6 space-y-6">
          ...
          <div className="pt-6 border-t border-slate-200">
            ...
            <div className="space-y-4">
              <InputField label="Business Name" name='businessName' icon={Building} type="text" value={formData.businessName} onChange={handleInputChange} placeholder="Your company"/>
              <TextareaField label="Address" name='address' icon={MapPin}  value={formData.address} onChange={handleInputChange} placeholder="XYZ address"/>
              <InputField label="Phone" name='phone' icon={Building} type="tel" value={formData.phone} onChange={handleInputChange} placeholder="987-678-6789"/>
            </div>
        ...
        <div className="px-6 py-4 border-t border-slate-200 bg-slate-50 flex justify-end ">
          <button type='submit' disabled={isUpdating} className='inline-flex items-center justify-center px-4 py-2 h-10 bg-blue-900 hover:bg-blue-800 text-white font-medium text-sm rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:cursor-not-allowed '>
