...
import {FileText, IndianRupee, IndianRupeeIcon, Loader2, Plus} from "lucide-react"
   ...
   <div className="space-y-8 ">
      <div>
        ...
        <p className="text-sm text-slate-600 mt-1">
          A quick overview of your business finaces.
        </p>
      </div>
        ...
        {recentInvoices.length>0?(
          <div className="w-[90vw] md:w-auto overflow-x-auto">
            <table className="w-full min-w-[600px] divide-y divide-slate-200">
              <thead className="bg-slate-50">
                <tr>
                  <th className="px-6 py-3 text-left text-xs font-medium text-slate-500 tracking-wider uppercase">
                    Client 
                  </th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-slate-500 tracking-wider uppercase">
                    Amount 
          ...
          <div className="flex flex-col items-center justify-center py-12 text-center">
            <div className="w-16 h-16 bg-slate-100 rounded-full flex items-center justify-center mb-4">
              <FileText className='w-8 h-8 to-slate-400' />
