              ...
              <div className="bg-white border border-slate-200 rounded-lg overflow-hidden">
                <table className="w-full divide-y divide-slate-200">
                  <thead className='bg-slate-50'>
                    <tr>
                      <th className="px-4 sm:px-6 py-3 text-left text-xs font-medium text-slate-500 tracking-wider uppercase">Item</th>
                      <th className="px-4 sm:px-6 py-3 text-center text-xs font-medium text-slate-500 tracking-wider uppercase">Qty</th>
                      <th className="px-4 sm:px-6 py-3 text-right text-xs font-medium text-slate-500 tracking-wider uppercase">Price</th>
                      <th className="px-4 sm:px-6 py-3 text-right text-xs font-medium text-slate-500 tracking-wider uppercase">Total</th>
                    </tr>
                  </thead>
