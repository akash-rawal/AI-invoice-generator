        ...
        <div className="bg-white rounded-lg shadow-xl max-w-lg w-full p-6 relative text-left transform transition-all">
          ...
          {isLoading? (
            ...
            <div className="space-y-4">
              <TextareaField name="reminderText" value={reminderText} readOnly rows={10} />
            </div>
          )}

          <div className="flex  justify-end space-x-3 mt-6">
            <Button variant='secondary' onClick={onClose}>Close</Button>
            <Button variant='secondary' onClick={handleCopyToClipboard} icon={hasCopied ? Check : Copy} disabled={isLoading}>
