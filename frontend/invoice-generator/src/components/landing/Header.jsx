...
const Header = () => {
    ...
    const user = {name:"Akash" ,email:"akashrawal@gmail.com"}
    const logout = ()=>{}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16 lg:h-20">
              ...
              <div className='hidden lg:flex items-center space-x-4'>
                ...
                <Link to="/signup" className='bg-gradient-to-r from-blue-950 to-blue-900 hover:bg-gray-800 text-white px-6 py-2.5 rounded-lg font-medium transition-all duration-200 hover:scale-105 hover:shadow-lg'>
                Sign Up
                </Link>
                </>)}
          ...
          {isMenuOpen &&(
            <div className="lg:hidden absolute top-full left-0 right-0 bg-white border-b border-gray-200 shadow-lg">
              <div className="px-2 pt-2 space-y-1 sm:px-3">
                ...
                {isAuthenticated?(
                  <div className="p-4">
                    <Button onClick={()=>navigate("/dashboard")} className='w-full cursor-pointer'>
                      Go to Dashboard 
                    </Button>
                  </div>
                ):(<>
