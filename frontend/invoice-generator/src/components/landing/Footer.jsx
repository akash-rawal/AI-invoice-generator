...
const FooterLink = ({ herf, to, children }) => {
  const className =
  ...
  return (
    <a href={herf} className={className}>
      {children}
    </a>
  );
};

const SocialLink = ({ herf, children }) => {
  return (
    <a href={herf} className="w-10 h-10 bg-blue-950 rounded-lg flex items-center justify-center hover:bg-gray-700 transition-colors duration-200" target="_blank" rel="noopener noreferrer">
      {children}
    </a>
  );
};
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="space-y-4 md:col-span-2 lg:col-span-1">
                    <Link className="flex items-center space-x-2 mb-6">
                ...
                <div >
                  ...
                  <ul className="space-y-2">
                    ...
                    <li>
                      <FooterLink to="/terms">terms od Services</FooterLink>
                    </li>
                  </ul>
                </div>
            </div>
